...
export class Registration<Shop extends ShopInterface = ShopInterface> {
	...
	/**
	 * This method checks the request for the handshake with the Onlishop Shop.
	...
	public async authorize(req: Request): Promise<Response> {
		...
		if (
			...
			!req.headers.has("onlishop-app-signature") ||
		...
		const v = await this.app.signer.verify(
			req.headers.get("onlishop-app-signature") as string,
	...
	/**
	 * This method is called by the Onlishop Shop to confirm the handshake.
	...
	public async authorizeCallback(req: Request): Promise<Response> {
		...
		if (
			...
			!req.headers.has("onlishop-shop-signature")
		) {
			return new InvalidRequestResponse("Invalid Request", 400);
		}
		...
		const v = await this.app.signer.verify(
			req.headers.get("onlishop-shop-signature") as string,
			bodyContent,
			shop.getShopSecret(),
		);
	...
	/**
	 * This method should be called by Onlishop Shop to set the shop active.
	 *
	 * <webhooks>
	...
	/**
	 * This method should be called by Onlishop when the app was installed.
	 *
	 * <webhooks>
	...
	/**
	 * This method should be called by Onlishop Shop to set the shop in-active.
	 *
	 * <webhooks>
	...
	/**
	 * This method should be called by Onlishop when the app was updated.
	 *
	 * <webhooks>
	...
	/**
	 * This method should be called by Onlishop Shop to delete the app.
	 *
	 * <webhooks>
