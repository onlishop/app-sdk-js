...
describe("Signer", () => {
	test("signResponse", async () => {
		...
		expect(response.headers.get("onlishop-app-signature")).toBe(
	...
	test("verifyGetRequest", async () => {
		...
		expect(
			signer.verifyGetRequest(
				new Request(
					"https://example.com/?onlishop-shop-signature=52589bd80ccfa4acbb3f9512dfaf4f700fa5195008aae0b77a9e47dcca75beac",
				),
				"test",
			),
		...
		expect(
			signer.verifyGetRequest(
				new Request(
					"https://example.com/?onlishop-shop-signature=52589bd80ccfa4acbb3f9512dfaf4f700fa5195008aae0b77a9e47dcca75beac&a=1",
				),
				"test",
			),
		...
		expect(
			signer.verifyGetRequest(
				new Request(
					"https://example.com/?onlishop-shop-signature=f2cb1044ac5a2cb807e1942b06433d23d66bcf7dfad1095b286203e5c1f39cb6&shop-id=blaa",
				),
				"test",
			),
		).resolves.pass();
