...
export class Criteria<T = object> {
	...
	/**
	 * @see \Onlishop\Core\Framework\DataAbstractionLayer\Search\Query\ScoreQuery.
	...
	/**
	 * @see \Onlishop\Core\Framework\DataAbstractionLayer\Search\Aggregation\Metric\AvgAggregation
	...
	/**
	 * @see \Onlishop\Core\Framework\DataAbstractionLayer\Search\Aggregation\Metric\CountAggregation
	...
	/**
	 * @see \Onlishop\Core\Framework\DataAbstractionLayer\Search\Aggregation\Metric\MaxAggregation
	...
	/**
	 * @see \Onlishop\Core\Framework\DataAbstractionLayer\Search\Aggregation\Metric\MinAggregation
	...
	/**
	 * @see \Onlishop\Core\Framework\DataAbstractionLayer\Search\Aggregation\Metric\StatsAggregation
	...
	/**
	 * @see \Onlishop\Core\Framework\DataAbstractionLayer\Search\Aggregation\Metric\SumAggregation
	...
	/**
	 * @see \Onlishop\Core\Framework\DataAbstractionLayer\Search\Aggregation\Bucket\TermsAggregation
	...
	/**
	 * @see \Onlishop\Core\Framework\DataAbstractionLayer\Search\Aggregation\Metric\EntityAggregation
	...
	/**
	 * @see \Onlishop\Core\Framework\DataAbstractionLayer\Search\Aggregation\Bucket\FilterAggregation
	 * Allows to filter an aggregation result
	 */
	static filter(
		name: string,
	...
	/**
	 * @see \Onlishop\Core\Framework\DataAbstractionLayer\Search\Aggregation\Bucket\DateHistogramAggregation
	...
	/**
	 * @see \Onlishop\Core\Framework\DataAbstractionLayer\Search\Sorting\FieldSorting.
	...
	/**
	 * @see \Onlishop\Core\Framework\DataAbstractionLayer\Search\Sorting\CountSorting.
	...
	/**
	 * @see \Onlishop\Core\Framework\DataAbstractionLayer\Search\Filter\ContainsFilter.
	...
	/**
	 * @see \Onlishop\Core\Framework\DataAbstractionLayer\Search\Filter\PrefixFilter.
	...
	/**
	 * @see \Onlishop\Core\Framework\DataAbstractionLayer\Search\Filter\SuffixFilter.
	...
	/**
	 * @see \Onlishop\Core\Framework\DataAbstractionLayer\Search\Filter\EqualsAnyFilter.
	...
	/**
	 * @see \Onlishop\Core\Framework\DataAbstractionLayer\Search\Filter\RangeFilter.
	...
	/**
	 * @see \Onlishop\Core\Framework\DataAbstractionLayer\Search\Filter\EqualsFilter.
	 * This allows to filter documents where the field matches a defined range
	 *
	...
	/**
	 * @see \Onlishop\Core\Framework\DataAbstractionLayer\Search\Filter\NotFilter.
